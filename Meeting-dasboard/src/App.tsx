...
import { Calendar, Home, Image, Monitor, Plus, User, Video } from "lucide-react"
    ...
    <div className="flex min-h-screen bg-[#0c0e1f]">
      ...
      <div className="w-64 border-r border-gray-800 flex flex-col">
        <div className="p-6 flex items-center gap-2">
          ...
          <span className="text-white text-xl font-semibold">Meeting</span>
        </div>

        <div className="mt-6 px-4">
          <p className="text-xs text-gray-400 mb-2 px-2">MAIN MENU</p>

          <div className="space-y-1">  {/* gap in y direction */}
      ...
      <div className="flex-1 flex">
        <div className="flex-1 p-6 border">
          ...
          <div className="mb-10 relative border">
        ...
        {/* Right Sidebar */}
        <div className="w-64 p-4 bg-[#0f1224] border border-amber-300">
          {/* Activity Overview */}
